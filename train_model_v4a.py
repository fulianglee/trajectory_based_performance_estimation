...
# ################### train loop ######################
# ---------------- run script -----------------------
loader = train_util.TrajectoryDataZipV4a6(train_data_zip_pth, observable_minute=80,
                                          offset_minute=15).get_loader(batch_size)
model = train_util.BaseModelV4a(num_node)
...
for j in range(epoch_size):
    ...
    for i, data in enumerate(loader):
        ...
        del x_nodes, x_ts, y_slots, seq_len, slot_log_probs, loss
